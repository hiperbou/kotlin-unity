...
@file:JsNonModule
@file:JsQualifier("UnityEngine.Experimental.Rendering")
@file:Suppress("INTERFACE_WITH_SUPERCLASS", "OVERRIDING_FINAL_MEMBER", "RETURN_TYPE_MISMATCH_ON_OVERRIDE", "CONFLICTING_OVERLOADS", "EXTERNAL_DELEGATION")
package csharp.UnityEngine.Experimental.Rendering
...
external enum class GraphicsFormat {
    None /* = 0 */,
    R8_SRGB /* = 1 */,
    R8G8_SRGB /* = 2 */,
    R8G8B8_SRGB /* = 3 */,
...
external enum class RayTracingMode {
    Off /* = 0 */,
    Static /* = 1 */,
    DynamicTransform /* = 2 */,
    DynamicGeometry /* = 3 */
...
external enum class DefaultFormat {
    LDR /* = 0 */,
    HDR /* = 1 */,
    DepthStencil /* = 2 */,
    Shadow /* = 3 */,
...
external enum class TextureCreationFlags {
    None /* = 0 */,
    MipChain /* = 1 */,
    Crunch /* = 64 */
}

external enum class FormatUsage {
    Sample /* = 0 */,
    Linear /* = 1 */,
    Sparse /* = 2 */,
    Render /* = 4 */,
